...
def main(args):
    ...
    for model, output_directory in model_generator:
        ...
        for (tag, tags), seqs in sorted_targets:
            ...
            unrelaxed_protein_pkl = os.path.join(
                output_directory, f'{output_name}_unrelaxed_protein.pkl'
            )
#            with open(unrelaxed_protein_pkl, "wb") as ofl:
#                pickle.dump(unrelaxed_protein, ofl)
            ...
            score_file_path = os.path.join(
                    output_directory, f'{output_name}_structure_metrics.csv'
                )
            with open(score_file_path, "w+") as fp:
                fp.write(f"{tag},{mean_plddt},{ptm}\n")
